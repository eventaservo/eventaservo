...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  protected
    ...
    def configure_account_update_params
      devise_parameter_sanitizer.permit(:account_update, keys: %i[name picture city country_id weekly_summary birthday ueacode about youtube telegram instagram facebook vk persona_retejo instruisto preleganto])
    end
