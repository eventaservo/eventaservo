// ActiveAdmin base JS — adapted from gem for use without Sprockets.
// Expects jQuery and jQuery UI to be available globally (window.$ / window.jQuery).
(function() {
  var exports = window.ActiveAdmin = {};
  "use strict";
