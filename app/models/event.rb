...
class Event < ApplicationRecord # rubocop:disable Metrics/ClassLength
  ...
  # Determines whether reminders should be rescheduled on update.
  # Only reschedules when the event start or end date has changed,
  # as other attribute changes don't affect reminder timing.
  #
  # @return [Boolean]
